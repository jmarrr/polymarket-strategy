...
- **IOC orders**: Immediate-or-Cancel orders fill available liquidity at target price, cancel unfilled portion
...
- IOC orders may partially fill if liquidity is limited — check dashboard for fill amounts.
